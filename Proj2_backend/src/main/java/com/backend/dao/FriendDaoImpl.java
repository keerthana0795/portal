...
private SessionFactory sessionFactory;
	...
	public List<User> getSuggestedUsers(User user) {
		...
		SQLQuery query=session.createSQLQuery("select * from backend where username in (select username from backend where username!=? minus (select from_id from FRIEND where to_id=?"
